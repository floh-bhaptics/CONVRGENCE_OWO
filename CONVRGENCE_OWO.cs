...
[assembly: MelonInfo(typeof(CONVRGENCE_OWO.CONVRGENCE_OWO), "CONVRGENCE_OWO", "1.0.1", "Florian Fahrenberger")]
[assembly: MelonGame("Monkey-With-a-Bomb", "CONVRGENCE")]

namespace CONVRGENCE_OWO
{
    public class CONVRGENCE_OWO : MelonMod
    {
        ...
        public class bhaptics_AdrenalineShot
        {
            ...
            public static void Postfix()
            {
                tactsuitVr.PlayBackFeedback("AdrenalineShot");
            }
        }
        ...
        public class bhaptics_StrangeSound
        {
            ...
            public static void Postfix()
            {
                tactsuitVr.PlayBackFeedback("NeckTingle");
            }
        }
        ...
        public class bhaptics_Damage1
        {
            ...
            public static void Postfix(PlayerBase __instance)
            {
                ...
                tactsuitVr.PlayBackHit("Hit", angleShift.Key, angleShift.Value);
            }
        }
        ...
        public class bhaptics_SnapLoot
        {
            ...
            public static void Postfix(PlayerBase __instance)
            {
                ...
                tactsuitVr.PlayBackFeedback(pattern);
            }
        }
        ...
        public class bhaptics_Whistle
        {
            ...
            {
                tactsuitVr.PlayBackFeedback("WhistleShort");
            }
        }
        ...
        public class bhaptics_Whistle2
        {
            ...
            public static void Postfix(Mouth __instance)
            {
                tactsuitVr.PlayBackFeedback("WhistleLong");
            }
        }
